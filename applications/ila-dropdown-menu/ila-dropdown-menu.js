...
class MenuButtonActionsActiveDescendant {
    constructor(domNode, performMenuAction) {
        ...
        this.buttonNode = domNode.querySelector('.ila-dropdown-menu__button');
        this.menuNode = domNode.querySelector('.ila-dropdown-menu__menu');
        ...
        var nodes = domNode.querySelectorAll('.ila-dropdown-menu__menu-item');
    ...
    setFocusToMenuitem(newMenuitem) {
        for (var i = 0; i < this.menuitemNodes.length; i++) {
            ...
            if (menuitem === newMenuitem) {
                ...
                menuitem.classList.add('ila-dropdown-menu__menu-item--focused');
    ...
    closePopup() {
        if (this.isOpen()) {
            ...
            for (let i = 0; i < this.menuitemNodes.length; i++) {
                this.menuitemNodes[i].classList.remove(
                    'ila-dropdown-menu__menu-item--focused'
                );
            }
...
window.addEventListener('load', function () {
    ...
    //     document.getElementById('action_output').value =
