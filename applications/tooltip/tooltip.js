const createTooltip = ((type, className) => {
    ...
    className.forEach(eachClass => {
        ...
        textBody.innerText = 'This title relates to more than one page';

        background.appendChild(textTitle);
        background.appendChild(textBody);
...
const createExample = () => {
    ...
    if (parentDiv) {
        const titleLight = document.createElement('h2');
        ...
        const titleDark = document.createElement('h2');
